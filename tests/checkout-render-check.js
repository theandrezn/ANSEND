...
const markup = checkout.renderCheckout({
  ...
  quote: { subtotalCents: 19990, discountCents: 0, serviceFeeCents: 1199, totalCents: 21189 },
  recommendations: [
...
assert(markup.includes("R$ 211,89") || markup.includes("R$ 211,89"), "Total must use BRL formatting");
...
const pix = checkout.renderPixResult({ attempt_id: "attempt", checkout: { total_cents: 21189 }, pix: { qr_code: "safe-code" } });
