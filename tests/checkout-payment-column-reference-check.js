...
assert(/\.ansend-checkout__promoted-card\s*\{[^}]*font-family:\s*var\(--checkout-field-font\);/s.test(css), "Promoted cards must use Plus Jakarta Sans");
assert(/\.ansend-checkout__promoted-price\s*\{[^}]*font-family:\s*var\(--checkout-field-font\);[^}]*font-variant-numeric:\s*lining-nums tabular-nums;/s.test(css), "Promoted prices must use modern tabular Plus Jakarta Sans numerals");
...
assert(css.includes('--checkout-field-font: "Plus Jakarta Sans"'), "Payment fields must use Plus Jakarta Sans as their visual font");
...
assert(/\.ansend-checkout__installment-trigger\s*\{[^}]*color:\s*#fff;[^}]*font-family:\s*var\(--checkout-field-font\);/s.test(css), "Installment selector must use white Plus Jakarta Sans text");
