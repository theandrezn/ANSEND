...
const checks = [
  ...
  [script.includes("checkout-license-bar"), "Frontend renders compact billing and license bar"],
  [script.includes("checkout-product-list"), "Frontend renders horizontal checkout product list"],
  [script.includes("checkout-product-row"), "Frontend renders compact product rows"],
  [script.includes("checkout-processor-note"), "Frontend explains Mercado Pago as the Pix processor"],
  [script.includes("checkout-recommendations"), "Frontend renders secondary checkout recommendations"],
  [script.includes("recommended-beat-card"), "Frontend renders compact recommended beat cards"],
  ...
  [styles.includes("grid-template-columns: minmax(0, 1fr) 360px"), "Desktop checkout uses compact main and 360px sticky summary columns"],
  [styles.includes("scroll-snap-type: x mandatory"), "Mobile recommendations use contained horizontal scroll snap"],
