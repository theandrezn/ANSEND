-- Migration YYYYMMDDHHMMSS for Purchases Members Area
-- Creates entitlements, license documents, and download logs tables.
...
create table if not exists public.purchase_entitlements (
  ...
  allowed_files text not null, -- snapshot of formats (e.g. 'MP3', 'MP3, WAV', etc.)
